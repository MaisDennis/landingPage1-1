...
import { Container } from './policyStyles' 
...
const SignInPage = () => {
  ...
  return (
    <Container>
      {/* <img className="greetingsImg" src={Image} alt="image" /> */}
      <ScrollToTop/>
      <div className="wrapper">
        <div className="greetingsCard">
          ...
          <p>
          Na Cardemon, privacidade e segurança são prioridades e nos comprometemos com a transparência do tratamento de dados pessoais dos nossos usuários/clientes. Por isso, esta presente Política de Privacidade estabelece como é feita a coleta, uso e transferência de informações de clientes ou outras pessoas que acessam ou usam nosso site. 
          ...
          Telefone e e-mail para fins de contato. 
          </p>
          <h3>
          ...
          <p>
          É a partir do seu consentimento que tratamos os seus dados pessoais. O consentimento é a manifestação livre, informada e inequívoca pela qual você autoriza a Cardemon a tratar seus dados. 
          ...
          O seu consentimento será obtido de forma específica para cada finalidade acima descrita, evidenciando o compromisso de transparência e boa-fé da Cardemon para com seus usuários/clientes, seguindo as regulações legislativas pertinentes. 

          Ao utilizar os serviços da Cardemon e fornecer seus dados pessoais, você está ciente e consentindo com as disposições desta Política de Privacidade, além de conhecer seus direitos e como exercê-los. 
          ...
          <p>
          A Cardemon assegura a seus usuários/clientes seus direitos de titular previstos no artigo 18 da Lei Geral de Proteção de Dados. Dessa forma, você pode, de maneira gratuita e a qualquer tempo: 
          ...
          Solicitar a portabilidade de seus dados, através de um relatório de dados cadastrais que a Cardemon trata a seu respeito. 
          ...
          <p>
          Para exercer seus direitos de titular, você deve entrar em contato com a Cardemon através dos seguintes meios disponíveis: 
          ...
          <p>
          Seus dados pessoais coletados pela Cardemon serão utilizados e armazenados durante o tempo necessário para a prestação do serviço ou para que as finalidades elencadas na presente Política de Privacidade sejam atingidas, considerando os direitos dos titulares dos dados e dos controladores. 

          De modo geral, seus dados serão mantidos enquanto a relação contratual entre você e a Cardemon perdurar. Findado o período de armazenamento dos dados pessoais, estes serão excluídos de nossas bases de dados ou anonimizados, ressalvadas as hipóteses legalmente previstas no artigo 16 lei geral de proteção de dados, a saber: 
          ...
          O armazenamento de dados coletados pela Cardemon reflete o nosso compromisso com a segurança e privacidade dos seus dados. Empregamos medidas e soluções técnicas de proteção aptas a garantir a confidencialidade, integridade e inviolabilidade dos seus dados. Além disso, também contamos com medidas de segurança apropriadas aos riscos e com controle de acesso às informações armazenadas. 
          </p>
          <h2>
          ...
          <p>
          Tendo em vista a preservação de sua privacidade, a Cardemon não compartilhará seus dados pessoais com nenhum terceiro não autorizado.  
          ...
          III – Proteção dos direitos da Cardemon em qualquer tipo de conflito, inclusive os de teor judicial. 
          </p>
          <h3>
          ...
          Nesse sentido, a Cardemon se compromete a sempre adotar eficientes padrões de segurança cibernética e de proteção de dados, nos melhores esforços de garantir e cumprir as exigências legislativas. 
          ...
          <p>
          A Cardemon faz uso de Cookies, que são arquivos de texto enviados pela plataforma ao seu computador e que nele se armazenam, que contém informações relacionadas à navegação do site. Em suma, os Cookies são utilizados para aprimorar a experiência de uso. 
          ...
          A Cardemon utiliza os seguintes Cookies: (descrição dos tipos de Cookies utilizados pelo site). 
          ...
          <p>
          A Cardemon prevê a responsabilidade dos agentes que atuam nos processos de tratamento de dados, em conformidade com os artigos 42 ao 45 da Lei Geral de Proteção de Dados. 
          ...
          Caso a Autoridade Nacional de Proteção de Dados exija a adoção de providências em relação ao tratamento de dados realizado pela Cardemon, comprometemo-nos a segui-las.  
          </p>
          <h3>
          10.1 Isenção de responsabilidade 
          </h3>
          <p>
          Conforme mencionado no Tópico 6, embora adotemos elevados padrões de segurança a fim de evitar incidentes, não há nenhuma página virtual inteiramente livre de riscos. Nesse sentido, a Cardemon não se responsabiliza por: 
          ...
          II – Ações maliciosas de terceiros, como ataques de hackers, exceto se comprovada conduta culposa ou deliberada da Cardemon. 
          ...
          III – Inveracidade das informações inseridas pelo usuário/cliente nos registros necessários para a utilização dos serviços da Cardemon; quaisquer consequências decorrentes de informações falsas ou inseridas de má-fé são de inteiramente responsabilidade do usuário/cliente. 
          </p>
          <h2>
          11. Encarregado de Proteção de Dados 
          </h2>
          <p>
          A Cardemon disponibiliza os seguintes meios para que você possa entrar em contato conosco para exercer seus direitos de titular: e-mail. 
